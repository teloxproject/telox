...
/** Utility functions used by the TELOX Qt UI.
 */
namespace GUIUtil
{
...
// Render TELOX addresses in monospace font
...
// Parse "telox:" URI into recipient object, return true on successful parsing
