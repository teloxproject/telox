...
#if defined(NDEBUG)
#error "Telox cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Telox Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
  ...
  if( nHeight >= 1 && nHeight <= 15000 ) {
                  nSubsidy = 3 * COIN;
      } else if (nHeight >= 15001 && nHeight <= 30000) {
          nSubsidy = 4 * COIN;
      } else if (nHeight >= 30001 && nHeight <= 50000) {
          nSubsidy = 5 * COIN;
      } else if (nHeight >= 50001 && nHeight <= 90000) {
          nSubsidy = 6 * COIN;
      } else if (nHeight >= 90001 && nHeight <= 250000) {
          nSubsidy = 8 * COIN;
      } else if (nHeight >= 250001 && nHeight <= 500000) {
          nSubsidy = 10 * COIN;
