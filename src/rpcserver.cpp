...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TELOX features */
        {"telox", "masternode", &masternode, true, true, false},
        {"telox", "masternodelist", &masternodelist, true, true, false},
        {"telox", "mnbudget", &mnbudget, true, true, false},
        {"telox", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"telox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"telox", "mnsync", &mnsync, true, true, false},
        {"telox", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"telox", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use teloxd, or the -server option to telox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> telox-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3301/\n";
}
