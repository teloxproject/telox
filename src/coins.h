...
/** 
    ...
    ****Note - for TELOX we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of telox coming in to a transaction
