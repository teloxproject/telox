/* src/config/telox-config.h.  Generated from telox-config.h.in by configure.  */
/* src/config/telox-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TELOX_CONFIG_H

#define TELOX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://telox.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Telox Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Telox Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "telox"
