...
This means one can have an always-on teloxd instance running, and another local teloxd/telox-qt instance which connects to this node and receives blocks from it.
