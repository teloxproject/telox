...
RESOURCES += src/qt/telox.qrc src/qt/telox_locale.qrc

TRANSLATIONS += src/qt/locale/telox_bg.ts \
                src/qt/locale/telox_de.ts \
                src/qt/locale/telox_en.ts \
                src/qt/locale/telox_es.ts \
                src/qt/locale/telox_fi.ts \
                src/qt/locale/telox_fr.ts \
                src/qt/locale/telox_it.ts \
                src/qt/locale/telox_ja.ts \
                src/qt/locale/telox_pl.ts \
                src/qt/locale/telox_pt.ts \
                src/qt/locale/telox_ru.ts \
                src/qt/locale/telox_sk.ts \
                src/qt/locale/telox_sv.ts \
                src/qt/locale/telox_vi.ts \
                src/qt/locale/telox_zh_CN.ts \
                src/qt/locale/telox_zh_TW.ts
